...
enum type { GREEN_LED, RED_LED, B_R_LED, B_C_LED, B_L_LED, L_TRIANGLE, R_TRIANGLE, ORANGE, DIANA, GAME_OVER, LEVER, TURBINE, RED_PANEL_1, RED_PANEL_2, RED_PANEL_3, RED_PANEL_4, BLUE_BUTTON };
